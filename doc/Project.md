...
### 2. Kafka
Для проверки простоты включения в контур новой системы брокера сообщений Kafka, релизован простой микросервис генерации и чтения сообщений - "events". Cервис реализован на языке Python, с использованием библиотек **Flask** и **requests**. Размещен в каталоге ./src/microservices/events. Конфигурация запуска добавлена в файл проекта docker-compose.yml.

![Издатели Kafka](img/producers.png)
![Подписчики Kafka](img/consumers.png)
![Kafka консоль](img/kafka_ui.png)
